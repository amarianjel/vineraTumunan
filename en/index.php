...
<head>
	...
	<!-- title -->
	<title>Vineyard Tumuñan Lodge | Start </title>
...
<body>
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li class="current-list-item"><a href="./">Start</a>
								</li>
				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							<p class="subtitle">The best wines in the downtown area</p>
    ...
    <main>
		<!--Carrusel-->
		<section>
            <div id="carouselExampleCaptionsEn" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-indicators">
                    <button type="button" data-bs-target="#carouselExampleCaptionsEn" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                    <button type="button" data-bs-target="#carouselExampleCaptionsEn" data-bs-slide-to="1" aria-label="Slide 2"></button>
                    <button type="button" data-bs-target="#carouselExampleCaptionsEn" data-bs-slide-to="2" aria-label="Slide 3"></button>
                    <button type="button" data-bs-target="#carouselExampleCaptionsEn" data-bs-slide-to="3" aria-label="Slide 4"></button>
                    <button type="button" data-bs-target="#carouselExampleCaptionsEn" data-bs-slide-to="4" aria-label="Slide 5"></button>
                    <button type="button" data-bs-target="#carouselExampleCaptionsEn" data-bs-slide-to="5" aria-label="Slide 6"></button>
                    <button type="button" data-bs-target="#carouselExampleCaptionsEn" data-bs-slide-to="6" aria-label="Slide 7"></button>
                </div>
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item overflow  carrusel-full">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <p class="carruselParrafo">Relax in a comfortable and pleasant stay</p>
                        </div>
                    </div>
                    <div class="carousel-item overflow carrusel-full">
                    ...
                    <div class="carousel-item overflow carrusel-full">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <p class="carruselParrafo"> Explore in the area, and enjoy what our environment has for you</p>
                        </div>
                    </div>
                    <div class="carousel-item overflow  carrusel-full">
                        <img src="../images/Activities/Wine Tours/1.jpg" class="d-block w-100 carrusel-full">
                        <div class="carousel-caption d-none d-md-block">
                            <p class="carruselParrafo"> Enjoy our excellent wines, that the San Fernando Valley has for you</p>
                        </div>
                    </div>
                    <div class="carousel-item overflow  carrusel-full">
                        <img src="../images/Activities/Wine Tours/2.jpg" class="d-block w-100 carrusel-full">
                        <div class="carousel-caption d-none d-md-block">
                            <p class="carruselParrafo">Join the tours that we prepare for you and learn about the process of our wines</p>
                        </div>
                    </div>
                    <div class="carousel-item overflow  carrusel-full">
                ...
                <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptionsEn" data-bs-slide="next">
                ...
                <div class="informacion">
                    <div class="box-col">
                        <div class="text-info">
                            ...
                            <br>
                            <div>
                                <p class="servicios">Rental of cabins in the Andes of Colchagua. Enjoy a good wine surrounded by snowy mountains and native forests.</p>
                            </div>
                        </div>
                        <div class="direccion">
                            ...
                            <div class="middle">
								...
								<h4 class="enunciado-tarjeta">Gallery</h4>
								<div class="text"><a class="boton" href="galeria.php">See more</a>
								</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-col">
                        <div class="direccion">
                            ...
                            <div class="middle">
                                ...
                                <h4 class="enunciado-tarjeta ">Store</h4><br>
                                
                                <div class="text"><a class="boton" href="tienda.php">See more</a></div>
                            </div>
                        </div>
                        <div class="direccion">
                            ...
                            <div class="middle">
                                <div class="text">
                                	...
                                	<h4 class="enunciado-tarjeta ">Lodging</h4>
									<br>
									<a class="boton" href="alojamientos.php">See more</a>
								</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-col">
                        <div class="direccion">
                            ...
                            <div class="middle">
                                ...
                                <h4 class="enunciado-tarjeta ">Excursions</h4><br>
                                <div class="text"><a class="boton" href="galeria.php#senderismo">See more</a></div>
                            </div>
                        </div>
                        ...
                        <div class="direccion">
                            ...
                            <div class="middle">
                                ...
                                <h4 class="enunciado-tarjeta ">Food and Wine</h4>
                                <br>
                                <div class="text"><a class="boton" href="galeria.php#comida_y_vinos">See more</a></div>    
                            </div>
                        </div>
                    </div>
                </div>
