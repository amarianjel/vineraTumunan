				...
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<ul>
								...
								<li class="current-list-item"><a href="tienda.php">Armazenar</a></li>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<p>Todos os tipos de vinhos e mais produtos</p>
						<h1>Armazenar</h1>
					</div>
				</div>
			</div>
                ...
                <?php foreach ($resultado as $row) { ?>
                    ...
                    <div class="col-lg-4 col-md-6 text-center <?php echo $row['categoria']; ?>">
                        <div class="single-product-item">
							...
							?>
                            <p class="product-price"><span>Preço</span><?php echo MONEDA . ' ' . number_format($precio_desc,'0',',','.'); ?></p>
							<?php }else{?>
							<p class="product-price"><span>Preço</span><?php echo MONEDA . ' ' . number_format($row['precio'],'0',',','.'); ?></p>
							<?php }?>
                            <a href="" class="cart-btn" onClick="addProducto(<?php echo $row['id']; ?>, '<?php echo hash_hmac('sha1', $row['id'], KEY_TOKEN); ?>')">
                                <i class="fas fa-shopping-cart"></i> Adicionar ao carrinho</a>
                        </div>
                    </div>
                    <?php } ?>
                </div>
