...
<body>
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li class="current-list-item"><a href="./">Começar</a>
								</li>
				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							<p class="subtitle">Os melhores vinhos do centro da cidade</p>
    ...
    <main>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item overflow  carrusel-full">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <p class="carruselParrafo">Relaxe em uma estadia confortável e agradável</p>
                        </div>
                    </div>
                    <div class="carousel-item overflow carrusel-full">
                        <img src="../images/food_Wine/cheese.jpg" class="d-block w-100 carrusel-full">
                        <div class="carousel-caption d-none d-md-block">
                            <p class="carruselParrafo">Desfrute do melhor da nossa vinha</p>
                        </div>
                    </div>
                    <div class="carousel-item overflow carrusel-full">
        ...
        <section class="new_info">
            <div>
                <div class="title">
                    <h1>Desfrute dos nossos serviços</h1> 
                </div>
                <div class="informacion">
                    <div class="box-col">
                        <div class="text-info">
                            ...
                            <br>
                            <div>
                                <p class="servicios">Aluguel de cabanas nos Andes de Colchagua. Desfrute de um bom vinho cercado por montanhas nevadas e florestas nativas.</p>
                            </div>
                        </div>
                        <div class="direccion">
                            ...
                            <div class="middle">
								...
								<div class="text"><a class="boton" href="galeria.php">Ver mais</a>
								</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-col">
                        <div class="direccion">
                            ...
                            <div class="middle">
                                ...
                                <h4 class="enunciado-tarjeta ">Armazenar</h4><br>
                                
                                <div class="text"><a class="boton" href="tienda.php">Ver mais</a></div>
                            </div>
                        </div>
                        <div class="direccion">
                            ...
                            <div class="middle">
                                <div class="text">
                                	...
                                	<h4 class="enunciado-tarjeta ">Alojamento</h4>
									<br>
									<a class="boton" href="alojamientos.php">Ver mais</a>
								</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-col">
                        <div class="direccion">
                            ...
                            <div class="middle">
                                ...
                                <h4 class="enunciado-tarjeta ">Excursões</h4><br>
                                <div class="text"><a class="boton" href="galeria.php#senderismo">Ver mais</a></div>
                            </div>
                        </div>
                        ...
                        <div class="direccion">
                            ...
                            <div class="middle">
                                ...
                                <h4 class="enunciado-tarjeta ">Comida e Vinho</h4>
                                <br>
                                <div class="text"><a class="boton" href="galeria.php#comida_y_vinos">Ver mais</a></div>    
                            </div>
                        </div>
                    </div>
                </div>
